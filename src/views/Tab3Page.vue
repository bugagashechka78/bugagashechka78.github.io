...
const modal_win = ref();
const my_recipe_name = ref('');
const my_recipe_calorie = ref('');
const my_recipe_ingredient = ref('');
const my_recipe_ingredient_quantity = ref('');

const createRecipe = function (recipe) {
  recipes.value.push(recipe);
  modal_win.value.$el.dismiss(null, 'cancel');
};
...
const infoRecipeOpen = async function (recipe) {
